...
\imageframekeepratio{rviz}
\imageframekeepratio{console}
\imageframekeepratio{bag}
\imageframekeepratio{dynamic_reconfigure}
...
\begin{frame}[plain]
    ...
    \resizebox{0.9\textwidth}{!}{%
        ...
        \begin{tikzpicture}
            ...
            \node[align=left] at (-4,4) {\Medium That's all folk!\\ \tt http://ros.org};
        \end{tikzpicture}
    }
\end{frame}
